...
void Game::SetupCamera(float dt)
{
	...
	mat_view = Matrix::CreateLookAt(game_level->camera.from, game_level->camera.to);
	mat_proj = Matrix::CreatePerspectiveFieldOfView(PI / 4 + sin(drunk_anim)*(PI / 16)*drunk_mod,
