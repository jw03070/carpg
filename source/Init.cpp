...
void Game::PreconfigureGame()
{
	...
	res_mgr->SetProgressCallback(ProgressCallback(gui->load_screen, &LoadScreen::SetProgressCallback));
}
...
void Game::AddLoadTasks()
{
	...
	ResourceManager& res_mgr = *this->res_mgr;
